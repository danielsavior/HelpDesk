...
public class AutoCompleteTextField extends JTextField implements KeyListener,
     ...
     */
    public AutoCompleteTextField(int columns, boolean caseSensitive,List<String>l) {
        super.setColumns(columns);
        //String[]n={"carne","bolo","caju","carambola","banana"};
        this.possibilities = new ArrayList<String>(l);
